...
const dict = {
  ...
  'Backup': ['EDITOR_HEADER_EDIT_BUTTON', 'MYSITE_PIVOT_SETTINGS', 'EDIT_FIELD_BACKUP_RESTORE'],
  ...
  'Change Site Name': ['EDITOR_HEADER_EDIT_BUTTON','MYSITE_PIVOT_SETTINGS', 'EDIT_FIELD_BUSINESS_PROFILE']
}
